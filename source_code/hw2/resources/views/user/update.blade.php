...
@endif
                        ...
                        <div class="form-group{{ $errors->has('hometown') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Hometown</label>

                            <div class="col-md-6">
                                <input id="hometown" type="text" class="form-control" name="hometown" value="{{ isset($user) ?$user->hometown : '' }}" required autofocus>
